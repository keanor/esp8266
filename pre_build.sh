...
cat skeleton.min.css | gzip > skeleton.min.css.gz
cd ${PROJECT_DIR}
cp ${WORK_DIR}/skeleton.min.css.gz resources/skeleton.min.css.gz

# Генерируем байт массив для архива с темой
xxd -i resources/skeleton.min.css.gz include/skeleton.inl
